...
public class CardboardRecipes {
    public static void registerRecipes() {
        ...
        ModHandler.addShapedRecipe(true, "cardboard_crate", CardboardMetaTileEntities.CARDBOARD_CRATE.getStackForm(),
                "RRR", "RPR", " R ",
                'R', new UnificationEntry(OrePrefix.plate, CardboardMaterials.Cardboard),
                'P', MetaItems.STICKY_RESIN.getStackForm());

        //ModHandler.addShapedRecipe(true, "cardboard_sheet", OreDictUnifier.get(OrePrefix.plate, CardboardMaterials.Cardboard),
        //        "CRC", "CRC", "CBC",
